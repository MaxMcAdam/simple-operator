...
import (
	...
	cachev1alpha1 "github.com/MaxMcAdam/simple-operator/pkg/apis/cache/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &cachev1alpha1.TopServiceOperator{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.TopServiceOperator{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &cachev1alpha1.TopServiceOperator{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileTopServiceOperator) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &cachev1alpha1.TopServiceOperator{}
	...
	// Set TopServiceOperator instance as the owner and controller
...
func newPodForCR(cr *cachev1alpha1.TopServiceOperator) *corev1.Pod {
